...
If no uv4l, go into install process.</td></tr><tr valign="top"><td>setupPubSubForSpjsConnect</td><td>function</td><td>function () <br><br>Subscribe to connect/disconnect events for SPJS so we can pivot off

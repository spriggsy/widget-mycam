...
Dual-webcam widget to ChiliPeppr using Linux Mjpg-Stream. Allows setting offset of camera from spindle and moving to that location by button press.
...
| Name                  | Widget / myCam |
| Description           | Dual-webcam widget to ChiliPeppr using Linux Mjpg-Stream. Allows setting offset of camera from spindle and moving to that location by button press. |

...
| Test URL              | https://preview.c9users.io/chilipeppr/com-chilipeppr-widget-cam/widget.html |
...
The table below shows, in order, the methods and properties inside the widget/element.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-widget-cam"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Widget / Cam"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"This widget loads a webcam view in ChiliPeppr via WebRTC."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/chilipeppr/com-chilipeppr-widget-cam/master/auto-generated-widget.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/chilipeppr/com-chilipeppr-widget-cam"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/chilipeppr/com-chilipeppr-widget-cam"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://com-chilipeppr-widget-cam-chilipeppr.c9users.io/widget.html"</td></tr><tr valign="top"><td>publish</td><td>object</td><td>Please see docs above.<br><br>Define the publish signals that this widget/element owns or defines so that
...
instantiating code like a workspace or a different widget.</td></tr><tr valign="top"><td>activate</td><td>function</td><td>function () <br><br>When this widget is activated</td></tr><tr valign="top"><td>deactivate</td><td>function</td><td>function () <br><br>When this widget is deactivated</td></tr><tr valign="top"><td>initCheckForCam</td><td>function</td><td>function () <br><br>When this widget is activated, we need to do a few things:

...
Dual-webcam widget to ChiliPeppr using Linux Mjpg-Stream.Allows setting ofset of camera from spindle and moving to that location vi button.
...
| Name                  | Widget / myCam |
| Description           | Dual-webcam widget to ChiliPeppr using Linux Mjpg-Stream.Allows setting ofset of camera from spindle and moving to that location vi button. |

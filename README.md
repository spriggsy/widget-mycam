...
This widget loads a webcam view in ChiliPeppr using Linux Mjpg-Stream.
...
| Name                  | Widget / myCam |
| Description           | This widget loads a webcam view in ChiliPeppr using Linux Mjpg-Stream. |

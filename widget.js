...
cpdefine("inline:com-chilipeppr-widget-mycam", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        ...
        desc: "Dual-webcam widget to ChiliPeppr using Linux Mjpg-Stream.Allows setting ofset of camera from spindle and moving to that location vi button.", // A description of what your widget does
